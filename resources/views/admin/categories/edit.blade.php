...
<div class="container-fluid">
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="mb-4">
                ...
                <input type="text"
                       ...
                       id="slug-preview"
                       value="{{ old('slug', $category->slug) ?: $category->slug }}"
                       readonly>
            </div>
            ...
            <textarea name="description"
                      ...
                      placeholder="Add category description...">{{ old('description', $category->description) }}</textarea>
        </div>
        ...
        <div class="col-lg-4">
            ...
            {{-- PUBLISH --}}
            <div class="card mb-4">
                <div class="card-header bg-light fw-semibold">Update</div>
                <div class="card-body">
            ...
            {{-- CATEGORY INFO --}}
            <div class="card mb-4">
                <div class="card-header bg-light fw-semibold">Category Info</div>
                <div class="card-body">
                    <dl class="row small">
                        <dt class="col-sm-5">ID:</dt>
                        <dd class="col-sm-7">{{ $category->id }}</dd>

                        <dt class="col-sm-5">Posts:</dt>
                        <dd class="col-sm-7">{{ $category->post_count }}</dd>

                        <dt class="col-sm-5">Created:</dt>
                        <dd class="col-sm-7">{{ $category->created_at->format('M j, Y') }}</dd>
                    </dl>
                </div>
            </div>
